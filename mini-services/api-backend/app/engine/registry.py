...
from .nodes.triggers import ChatTriggerNode, DatasetTriggerNode, ErrorTriggerNode, EventTriggerNode, ManualTriggerNode, ScheduleTriggerNode, WebhookTriggerNode
...
for _cls in (
    ...
    EventTriggerNode,   # v80: fire when a system event matches the type pattern
    HttpRequestNode,
    ExecuteWorkflowNode,
    IfConditionNode,
    SwitchNode,
