...
def test_v27_definitions():
    async def _go():
        async with _client() as client:
            ...
            assert props["dataset_write"] == {"dataset", "mode", "key_columns", "create_if_missing", "watermark_column", "ingestion_key"}  # key_columns: v45 upsert; watermark/key: v50 incremental
