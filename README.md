...
| The Harness | The system's own agentic runtime: a 10-tool chest over the estate itself, guard rails (repeat/budget/clock), and fail-closed human approvals on every move that changes the business |
