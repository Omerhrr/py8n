...
import {
  ...
  Globe, Rocket, MessagesSquare, Webhook, Video, Zap, Sparkles as ComposerIcon, GitBranch, Gavel,
  ...
  >
    ...
    <div class="shrink-0 border-t border-zinc-800/80 p-3">
      ...
      <div class="flex items-center justify-between gap-2 text-[10px] text-zinc-600" :class="collapsed && 'lg:justify-center'">
        <span class="truncate" :class="collapsed && 'lg:hidden'">v1.111 · 68 node types</span>
      </div>
    </div>
  </aside>
