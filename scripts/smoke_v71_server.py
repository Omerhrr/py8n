"""V71 smoke helper: boot the real py8n app with a deterministic ASR engine
...
Usage (the v71 smoke launches this, not you):
    python scripts/smoke_v71_server.py   # PORT env, default 8199
"""
